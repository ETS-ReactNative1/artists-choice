    ...
    return (
      <div className="wow fadeIn">
        {this.props.loggedInUser.userType === "artist" ? (
              ...
              <form className="artist-signup-form">
                ...
                <div id="genre-form-group" className="form-group">
                  <select
                    ...
                    onChange={this.handleArtistGenreChange}
                  >
                ...
                <div id="country-form-group" className="form-group">
                  <select
                    ...
                    defaultValue="US"
                    onChange={this.handleArtistCountryChange}
                  >
                ...
                <div id="zipcode-form-group" className="form-group">
                  <input
                    ...
                    onChange={this.handleArtistZipCodeChange}
                  />
                ...
                <button
                  ...
                  onClick={this.processArtistDetails}
                >
                  Continue
                </button>
              </form>
          ...
          <div id="fan-info-form-container">
              ...
              <form className="fan-signup-form">
                <div id="name-form-group" className="form-group">
                  <input
                    ...
                    className="form-control"
                    id="name"
                    aria-describedby="fanName"
                    placeholder="Username *"
                    value={this.state.fanName}
                    onChange={this.handleFanNameChange}
                  />
                  <div id="invalid-email-text" className="invalid-field-text">
                    Name must be at least 2 characters with no invalid symbols.
                  </div>
                ...
                <div id="country-form-group" className="form-group">
                  <select
                    className="form-control"
                    id="country"
                    aria-describedby="fanCountry"
                    defaultValue="US"
                    onChange={this.handleFanCountryChange}
                  >
                    <option value="AF">Afghanistan</option>
                    <option value="AX">Aland Islands</option>
                    <option value="AL">Albania</option>
                ...
                <div id="zipcode-form-group" className="form-group">
                  <input
                    ...
                    aria-describedby="zipCode"
                    placeholder="ZIP/Postalcode *"
                    value={this.state.fanZipcode}
                    onChange={this.handleFanZipCodeChange}
                  />
                  <div id="invalid-zipcode-text" className="invalid-field-text">
                    Invalid zip/postalcode.
                  </div>
                ...
                <button
                  id="signup-button"
                  className="btn btn-primary"
                  onClick={this.processFanDetails}
                >
                  Continue
                </button>
              </form>
